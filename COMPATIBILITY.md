...
The annual basin output includes unlabelled `cal_sim` (29 characters) and `cal_adj` (17 characters), after its water-balance fields. SWATreadR 0.1.0.9014 reads these without assigning them to crop labels; SWATdoctR uses that reader. SWATtunR warns about observation-only crops and prevents misaligned PHU/yield/biomass panels. The seven bundled SWAT packages pass 96 focused expectations, including native annual output, plant-table migration, unresolved-plant detection and cropped-panel coverage.
